...
<section>
    <x-aui::dialog dismissable="true" x-cloak>
        ...
        <x-slot:content class="sm:max-w-[425px]">
            ...
            <form id="edit-issue-form-{{ $issue->id }}" method="POST" action="{{ route('issues.update', $issue->id) }}">
                @csrf
                @method('PUT')
                <div class="grid gap-4 py-4">
                    <div class="grid grid-cols-4 items-center gap-4">
                        ...
                        <x-select
                            ...
                            :value="old('task_id', $issue->task_id)"
                            required
                            class="col-span-3"
                        />
                    </div>
                    ...
                    <div class="grid grid-cols-4 items-center gap-4">
                        ...
                        <x-aui::input
                            ...
                            class="col-span-3"
                            name="due_date"
                            value="{{ old('due_date', $issue->due_date ? \Illuminate\Support\Carbon::parse($issue->due_date)->format('Y-m-d') : '') }}"
